...
export const siteCopySaveSchema = z.object({
  ...
  about: z.object({
    title: z.string().min(1).max(200),
    lede: z.string().max(4000).optional().default(""),
    heroEyebrow: z.string().max(200).optional().default(""),
    heroHeadline: z.string().max(300).optional().default(""),
    heroSubheadline: z.string().max(500).optional().default(""),
    heroBody: z.string().max(8000).optional().default(""),
    heroPrimaryCtaLabel: z.string().max(120).optional().default(""),
    heroPrimaryCtaUrl: z.string().max(500).optional().default("/partner"),
    heroSecondaryCtaLabel: z.string().max(120).optional().default(""),
    heroSecondaryCtaUrl: z.string().max(500).optional().default("#story"),
    sections: z.array(sectionSchema).min(1).max(12),
    closingCtaHeadline: z.string().max(200).optional().default(""),
    closingCtaBody: z.string().max(2000).optional().default(""),
    closingPrimaryCtaLabel: z.string().max(120).optional().default(""),
    closingPrimaryCtaUrl: z.string().max(500).optional().default("/partner"),
    closingSecondaryCtaLabel: z.string().max(120).optional().default(""),
    closingSecondaryCtaUrl: z.string().max(500).optional().default("/give"),
    closingTertiaryCtaLabel: z.string().max(120).optional().default(""),
    closingTertiaryCtaUrl: z.string().max(500).optional().default("/contact"),
  }),
  mission: z.object({
    title: z.string().min(1).max(200),
