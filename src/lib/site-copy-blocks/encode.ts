...
export function siteCopyToBlocks(copy: SiteCopy): ContentBlock[] {
  ...
  blocks.push(
    ...
    scalar(
      ...
      "about",
      "hero",
      "about.heroPrimaryCtaLabel",
      "Hero primary CTA label",
      copy.about.heroPrimaryCtaLabel,
      "cta",
    ),
    scalar(
      order,
      "about",
      "hero",
      "about.heroPrimaryCtaUrl",
      "Hero primary CTA URL",
      copy.about.heroPrimaryCtaUrl,
      "text",
    ),
    scalar(
      order,
      ...
      copy.about.heroSecondaryCtaLabel,
      "cta",
    ),
    scalar(
      order,
      "about",
      "hero",
      "about.heroSecondaryCtaUrl",
      "Hero secondary CTA URL",
      copy.about.heroSecondaryCtaUrl,
      "text",
    ),
    block(order, {
      pageKey: "about",
    ...
    scalar(
      ...
      "about",
      "closing",
      "about.closingCtaHeadline",
      "Closing CTA headline",
      copy.about.closingCtaHeadline,
      "heading",
    ),
    scalar(
      order,
      "about",
      "closing",
      "about.closingCtaBody",
      "Closing CTA body",
      copy.about.closingCtaBody,
      "textarea",
    ),
    scalar(
      order,
      ...
      copy.about.closingPrimaryCtaLabel,
      "cta",
    ),
    scalar(
      order,
      "about",
      "closing",
      "about.closingPrimaryCtaUrl",
      "Closing primary CTA URL",
      copy.about.closingPrimaryCtaUrl,
      "text",
    ),
    scalar(
      order,
      ...
      copy.about.closingSecondaryCtaLabel,
      "cta",
    ),
    scalar(
      order,
      ...
      "Closing secondary CTA URL",
      copy.about.closingSecondaryCtaUrl,
      "text",
    ),
    scalar(
      order,
      ...
      "Closing tertiary CTA label",
      copy.about.closingTertiaryCtaLabel,
      "cta",
    ),
    scalar(
      order,
      ...
      "Closing tertiary CTA URL",
      copy.about.closingTertiaryCtaUrl,
      "text",
    ),
  );
