...
export function blocksToSiteCopy(blocks: ContentBlock[]): SiteCopy {
  ...
  return {
    ...
    about: {
      ...
      heroEyebrow: fieldValue(byKey, "about.heroEyebrow", d.about.heroEyebrow),
      heroHeadline: fieldValue(byKey, "about.heroHeadline", d.about.heroHeadline),
      heroSubheadline: fieldValue(byKey, "about.heroSubheadline", d.about.heroSubheadline),
      heroBody: fieldValue(byKey, "about.heroBody", d.about.heroBody),
      heroPrimaryCtaLabel: fieldValue(byKey, "about.heroPrimaryCtaLabel", d.about.heroPrimaryCtaLabel),
      heroPrimaryCtaUrl: fieldValue(byKey, "about.heroPrimaryCtaUrl", d.about.heroPrimaryCtaUrl),
      heroSecondaryCtaLabel: fieldValue(
        byKey,
        "about.heroSecondaryCtaLabel",
        d.about.heroSecondaryCtaLabel,
      ),
      heroSecondaryCtaUrl: fieldValue(byKey, "about.heroSecondaryCtaUrl", d.about.heroSecondaryCtaUrl),
      sections: aboutSections,
      closingCtaHeadline: fieldValue(byKey, "about.closingCtaHeadline", d.about.closingCtaHeadline),
      closingCtaBody: fieldValue(byKey, "about.closingCtaBody", d.about.closingCtaBody),
      closingPrimaryCtaLabel: fieldValue(
        byKey,
        "about.closingPrimaryCtaLabel",
        d.about.closingPrimaryCtaLabel,
      ),
      closingPrimaryCtaUrl: fieldValue(byKey, "about.closingPrimaryCtaUrl", d.about.closingPrimaryCtaUrl),
      closingSecondaryCtaLabel: fieldValue(
        byKey,
        "about.closingSecondaryCtaLabel",
        d.about.closingSecondaryCtaLabel,
      ),
      closingSecondaryCtaUrl: fieldValue(
        byKey,
        "about.closingSecondaryCtaUrl",
        d.about.closingSecondaryCtaUrl,
      ),
      closingTertiaryCtaLabel: fieldValue(
        byKey,
        "about.closingTertiaryCtaLabel",
        d.about.closingTertiaryCtaLabel,
      ),
      closingTertiaryCtaUrl: fieldValue(
        byKey,
        "about.closingTertiaryCtaUrl",
        d.about.closingTertiaryCtaUrl,
      ),
    },
    mission: {
